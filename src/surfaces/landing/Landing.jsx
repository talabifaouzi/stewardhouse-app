...
const surfaces = [
  {
    ...
    label: 'Individual',
    sub: 'Member view',
    description: 'For athletes, musicians, entertainers, and creators using StewardHouse personally.',
    ...
    <main style={{
      ...
      <section style={{
        ...
        <h1 style={{
          ...
          A platform for stewardship — across athletes, creators, and the institutions that support them.
        </h1>
        <p style={{
          fontSize: 'var(--sh-text-lg)',
