...
const NAV_ITEMS = [
  ...
  { key: 'advisors', label: 'Advisors', path: '/operations/advisors' },
  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        <Stat label="Advisors" value="11" sub="Practices on platform" />
      ...
      <div style={{
        ...
        <Card>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <ActivityRow time="14 min ago" surface="Advisor" detail="Morgan Walker created a new fork of 'Reading a 990' lesson" first />
            ...
            <ActivityRow time="6 hr ago" surface="Advisor" detail="Cohort 'Spring 2026 — first NIL signers' published an update" />
          </div>
        </Card>
        ...
        <Card tint>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Devon Kearns reports content not surfacing
            </p>
            <p style={{
              fontSize: 'var(--sh-text-xs)',
              color: 'var(--sh-text-muted)',
