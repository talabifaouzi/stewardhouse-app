    ...
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        <Routes>
          ...
          <Route path="setup" element={<SectionPlaceholder title="Setup" subtitle="Initial program configuration: program name, advisors, sports covered, and stage labels." note="Sub-flow nested under Enterprise — not a standalone surface." />} />
