...
Five hard-earned lessons from a night of failed browser screening attempts (2026-07-02), plus three findings added 2026-07-20 (two session-minting, from P-2 screening; one log-reading, from the §11 auth incident), plus two STANDING RULES added 2026-08-15 (browser automation; build-output reading). Any future FT-facing browser screen of an auth-gated surface must respect these, and the two standing rules bind every slice, screening or not:
