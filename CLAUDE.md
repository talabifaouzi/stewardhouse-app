...
Five hard-earned lessons from a night of failed browser screening attempts (2026-07-02), plus two session-minting findings added during P-2 screening (2026-07-20). Any future FT-facing browser screen of an auth-gated surface must respect these:
