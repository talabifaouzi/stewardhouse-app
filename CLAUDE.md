...
**Production gate state (verified against remote D1, 2026-07-16).** All 15
migrations applied `--remote`. `$.ops.demo_gate=1` on one ops row — **Operations
writes are LIVE**. `$.advisor.demo_gate=0` on all advisor rows and
