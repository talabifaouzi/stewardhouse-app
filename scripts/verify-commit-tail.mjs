...
// consumes.
const DERIVED_CLAIMS = [['THE BUILD CHAIN IS UNCHANGED AT', '20']];
...
function checkPairsAndDerived(ctx) {
  ...
  const s = {
    ...
    buildChain: grab(/THE BUILD CHAIN IS UNCHANGED AT (\d+)\*\*/),
  ...
  const PAIRS = [
    ['OPEN total', s.open, m.open, [['As committed:', '122']]],
    ['BLOCKING', s.blocking, m.blocking, [['AGAINST THE PILOT GATE:', '24']]],
    ['DEBT (OPEN-scoped)', s.debt, m.debt, [['AGAINST THE PILOT GATE:', '68']]],
    ['POST', s.post, m.post, [['AGAINST THE PILOT GATE:', '30']]],
    ['BMF and Discover tier', s.bmfTier, m.bmfTier, [['7, BMF-and-Discover 17', '17']]],
    ['naive enumerator', s.naive, m.naive, [['dangerous kind. Matching', '120']]],
    ['file-wide DEBT', s.debtFileWide, m.debtFileWide, [['A file-wide `Pilot: DEBT` count returns', '69']]],
    ...
    ['cheap-and-mechanical tier', s.tierCheap, m.tierCheap, [['7, BMF-and-Discover 17', '34']]],
    ['large tier', s.tierLarge, m.tierLarge, [['7, BMF-and-Discover 17', '38']]],
    ...
    ['tier breakdown string', s.breakdownParts, m.breakdownParts,
      [['the breakdown reads', '7'], ['the breakdown reads', '16'], ['the breakdown reads', '17'],
       ['the breakdown reads', '34'], ['the breakdown reads', '38'], ['the breakdown reads', '3']]],
    ['tier breakdown stated sum', s.breakdownSum, m.open, [['the breakdown reads', '122']]],

    ['arithmetic block: OPEN to-endpoint', s.blockOpen, m.open, [['OPEN moves 120 to 122', '122']]],
    ['arithmetic block: DEBT to-endpoint', s.blockDebt, m.debt, [['OPEN moves 120 to 122', '68']]],
    ['arithmetic block: BLOCKING stays', s.blockBlocking, m.blocking, [['OPEN moves 120 to 122', '24']]],
    ['arithmetic block: POST stays', s.blockPost, m.post, [['and POST stays 30.', '30']]],
    ['arithmetic block: cheap tier to-endpoint', s.blockCheap, m.tierCheap, [['the breakdown reads', '34']]],
    ['arithmetic block: file-wide DEBT to-endpoint', s.blockDebtFileWide, m.debtFileWide, [['DIAGNOSTIC MOVES 67 TO 69', '69']]],
    ['arithmetic block: naive restatement', s.blockNaive, m.naive, [['naive enumerator moves with OPEN, **120 against 122**', '120']]],
    ['arithmetic block: naive restatement, OPEN half', s.blockNaiveOpen, m.open, [['naive enumerator moves with OPEN, **120 against 122**', '122']]],

    ['naive enumerator contrast (OPEN total)', s.naiveOpen, m.open, [['dangerous kind. Matching', '122']]],
    ['file-wide DEBT contrast (OPEN-scoped)', s.debtFileWideContrast, m.debt, [['rather than 68, for the FJ-7 reason', '68']]],
    ...
    ['FJ-7 three-totals sum', s.fj7Sum, m.blocking + m.debt + m.post,
      [['which remain a count of OPEN entries and sum to', '122']]],
